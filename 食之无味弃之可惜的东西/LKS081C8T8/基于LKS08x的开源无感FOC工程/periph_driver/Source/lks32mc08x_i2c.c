...
void I2C_Init(I2C_TypeDef* I2Cx, I2C_InitTypeDef* I2C_InitStruct)
{
    ...
    I2Cx->ADDR =   (u32)I2C_InitStruct->ADRCMP << 7;

    I2Cx->CFG  =     (u32)(I2C_InitStruct->IE            <<  7 ) | (u32)(I2C_InitStruct->TC_IE    << 6)
                   | (u32)(I2C_InitStruct->BUS_ERR_IE    <<  5 ) | (u32)(I2C_InitStruct->STOP_IE  << 4)
                   | (u32)(I2C_InitStruct->MST_MODE      <<  1 ) | (u32)(I2C_InitStruct->SLV_MODE << 0);

    I2Cx->SCR  =   0;

    I2Cx->MSCR =   0;

    I2Cx->BCR  =   (u32)I2C_InitStruct->BURST_NACK << 7  | (u32)(I2C_InitStruct->BURST_ADDR_CMP  << 6)
                   | (u32)(I2C_InitStruct->DMA     << 5);
...
void i2c_dma_tx(u8 addr, u8 *data, u8 len)
{
	...
	DMA_CH3->DMA_CTMS = (u32)((len+1)<<16)|1;            // DMA搬运的数据长度
...
void i2c_dma_rx(u8 addr, u8 *data, u8 len)
{
	...
	DMA_CH3->DMA_CCR &=~BIT0;
	DMA_CH3->DMA_CMAR = (u32)data;				  // DMA发送数据地址
	DMA_CH3->DMA_CTMS = (u32)((len)<<16)|1;            // DMA搬运的数据长度

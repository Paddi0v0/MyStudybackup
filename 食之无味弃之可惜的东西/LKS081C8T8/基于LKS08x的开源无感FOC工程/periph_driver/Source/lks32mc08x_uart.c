...
void UART_Init(UART_TypeDef* UARTx, UART_InitTypeDef* UART_InitStruct)
{
    ...
    UARTx->CTRL = (u32)UART_InitStruct->WordLength | (u32)(UART_InitStruct->StopBits << 1)
                  | (u32)(UART_InitStruct->FirstSend << 2) | (u32)(parity << 3)
                  | (u32)(parityEna << 4) | (u32)(UART_InitStruct->MultiDropEna << 5)
                  | (u32)(UART_InitStruct->Bit9Value << 6) ;

    UARTx->INV = (u32)(UART_InitStruct->RXD_INV << 1) | (u32)UART_InitStruct->TXD_INV;

    UARTx->ADR = (u32)UART_InitStruct->Match485Addr;
    UARTx->IE = (u32)UART_InitStruct->IRQEna;
}

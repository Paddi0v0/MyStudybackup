...
{
    if (DMA_GetIRQFlag(DMA_CH3 , DMA_CH3_FIF)) //获取DMA通道3完成中断标志
    {        
       DMA_ClearIRQFlag(DMA_CH3 , DMA_CH3_FIF);//清除DMA通道3完成中断标志
			 /*可以调用CAN_DMA_RX（）函数一直进行数据接收，也可以调用DMA_CHx_EN（）
		     函数进行数据接收但DMA_CHx_EN（）函数无法改变发送数据地址和轮数*/

 ...
 * <tr><td>2016年04月19日 <td>1.0     <td>cfwu      <td>创建
 * </table>
 */
 ...
 * <table>
 * <tr><th>Date	        <th>Version    <th>Author      <th>Description
 * <tr><td>2015年11月26日 <td>1.0       <td>cfwu           <td>创建
 * </table>
 */
 ...
 *@param输入参数：       无
 *@param输出参数：       无
 *@return返 回 值：      经过滤波的HALL信号结果值，第三位有效，其它位恒为0
 *@note其它说明：        无
 *@warning              无
 *@par 示例代码：
 *@code
 ...
 *@param输入参数：       无
 *@param输出参数：       无
 *@return返 回 值：      未滤波的HALL信号结果值，第三位有效，其它位恒为0
 *@note其它说明：        无
 *@warning              无
 *@par 示例代码：
 *@code
...
/**
 *@brief @b 函数名称:   uint32_t HALL_WIDCount(void)
 *@brief @b 功能描述:   读取HALL信号变化事件时刻HALL计数值
 *@see被引用内容：       无
 *@param输入参数：       无
 *@param输出参数：       无
 *@return返 回 值：      获取三颗HALL信号任何一个信号发生变化事件时刻的HALL计数器的计数值
 *@note其它说明：        无
 *@warning              无
 *@par 示例代码：
 *@code
		    uint32_t HALL_Value = 0;
            HALL_Value = HALL_WIDCount();//读取HALL信号变化事件时HALL计数值
  @endcode
 *@par 修改日志:
 * <table>
 * <tr><th>Date	        <th>Version  <th>Author  <th>Description
 ...
 * </table>
 *@param输出参数：       无
 *@return返 回 值：      HALL中断标志 为1即对应标志位置位，为0即对应标志位未置位
 *@note其它说明：        无
 *@warning              无
 *@par 示例代码：
 *@code
 ...
 * <table>
 * <tr><th>Date	        <th>Version  <th>Author  <th>Description
 * <tr><td>2022年5月20日  <td>1.0     <td>HuangMG     <td>创建
 * </table>
 */

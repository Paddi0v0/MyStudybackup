...
void ADC0_init(void)
{
    ...
    ADC_CHN_GAIN_CFG(ADC1,CHN0,ADC_CHANNEL_9,ADC_GAIN3V6);
    ADC_CHN_GAIN_CFG(ADC1,CHN1,ADC_CHANNEL_9,ADC_GAIN7V2);
		ADC_CHN_GAIN_CFG(ADC1,CHN2,ADC_CHANNEL_9,ADC_GAIN3V6);
    ADC_CHN_GAIN_CFG(ADC1,CHN3,ADC_CHANNEL_9,ADC_GAIN7V2);
}

...
void UART_init(void)
{
    ...
    UART_InitStruct.WordLength   = UART_WORDLENGTH_9b;  /* 多机通讯数据长度需选择9bit模式 */
    ...
    UART_InitStruct.MultiDropEna = ENABLE;              /* 使能485通讯*/
	  UART_InitStruct.Match485Addr = 0x32;                /* 485通讯主机地址0x32*/
	  /*使能接收和发送完成中断*/

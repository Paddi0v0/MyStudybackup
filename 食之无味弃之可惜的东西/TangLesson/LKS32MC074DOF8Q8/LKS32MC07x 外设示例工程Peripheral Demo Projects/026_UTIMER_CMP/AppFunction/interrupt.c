...
{
   if(TIM_GetFlag(UTIMER3,TIMER_CH0_IF))
	 {
	    TIM_ClearIRQFlag(UTIMER3,TIMER_CH0_IF);
	 }
	 if(TIM_GetFlag(UTIMER3,TIMER_CH1_IF))
	 {
	    TIM_ClearIRQFlag(UTIMER3,TIMER_CH1_IF);
	 }
	 if(TIM_GetFlag(UTIMER3,TIMER_ZC_IF))
	 {
	    TIM_ClearIRQFlag(UTIMER3,TIMER_ZC_IF);
	 }
}
/*******************************************************************************

#!/usr/bin/env python
# -*- coding: gbk -*-
# # 设置编码为utf-8 ---/---coding=****utf-8 # 设置编码为utf-8
# stcflash  Copyright (C) 2013  laborer (laborer@126.com)

# python ./tools/stcflash.py -p COM3 "${hexFile}" # 使用COM3口进行烧录Hex文件
# # 设置编码为gbk -*- coding: gbk -*-
# python ./tools/stcflash.py -p ${port} "${hexFile}" 这是原始的Python脚本运行命令
